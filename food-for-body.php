		...
		<div class="container">	
			...
			<div class="main">
				<div id="mi-slider" class="mi-slider">
					<ul>
						<li><a href="#"><img style="max-width: 130%;" src="images/image-food2.jpg" alt="img01"><h4>A</h4></a></li>
						<li><a href="#"><img style="max-width: 130%;" src="images/image-device-1.jpg" alt="img01"><h4>B</h4></a></li>
						<li><a href="#"><img style="max-width: 100%;" src="images/image-device-2.jpg" alt="img02"><h4>C</h4></a></li>
						<li><a href="#"><img style="max-width: 100%;" src="images/image-device-3.jpg" alt="img01"><h4>D</h4></a></li>
					</ul>
					<nav>
						<a href="#">Number 1.)</a>
					</nav>
